...
<header>
	...
	<div class="menu">
		<ul>
			<li class="logo"><a href=""><img height="44" title="CodeIgniter Logo"
...
<div class="further">
	...
	<section>
		...
		<p>The User Guide contains an introduction, tutorial, a number of "how to"
			...
			the framework. Check the <a href="#" >User Guide</a> !</p>
		...
		<p>CodeIgniter is a community-developed open source project, with several
			 ...
			 the threads on <a href="#">CodeIgniter's forum</a>, or <a href="#" >chat on Slack</a> !</p>
